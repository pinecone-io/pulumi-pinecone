...
namespace PineconeDatabase.Pinecone.Inputs
{
    ...
    public sealed class IndexSpecPodArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.IndexSpecPodMetadataConfigArgs>? MetadataConfig { get; set; }
        ...
        public IndexSpecPodArgs()
        {
        }
        public static new IndexSpecPodArgs Empty => new IndexSpecPodArgs();
    }
}
