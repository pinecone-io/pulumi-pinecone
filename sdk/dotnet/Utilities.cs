...
namespace PineconeDatabase.Pinecone
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pinecone-io/pulumi-pinecone";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PineconeDatabase.Pinecone.version.txt");
    ...
    internal sealed class PineconeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PineconeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
